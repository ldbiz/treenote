...
- **Rename Nodes**: Long-press on a node label to rename it, or right-click and choose **Rename**.
- **Delete Notes**: Select a node and use the delete button in the toolbar, or right-click and choose **Delete**. Deleting a node with children asks for confirmation.
